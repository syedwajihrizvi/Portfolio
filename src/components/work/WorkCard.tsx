        ...
        return <>
                ...
                <Box className="container container--padding">
                    <Box className='work-card__skills'>
                        {information.skills.map(skill => <Skill label={skill}/>)}
                    </Box>
                </Box>
        </>
    }
                    ...
                    <List disablePadding={true}>
                        {information.detailedPoints.map(point =>
                           <ListItem disablePadding={true} disableGutters>
                            <ListItemIcon><CheckIcon sx={{color: '#03fc98'}}/></ListItemIcon>
                                <ListItemText><Typography className='work-card__points'>{point}</Typography></ListItemText>
                            </ListItem>
                        )}
                    </List>
                </CardContent>
    ...
    return (
            <Card
                ...
                <Box>
                    ...
                    <CardActions className="work-card__action">
