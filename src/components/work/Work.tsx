...
const companies: workInformation[] = [
  {
    ...
    detailedPoints: [
      "AI powered interview preparation tools that provides user questions, feedback, and profile analysis.",
      "Quick Apply feature that allows users to apply to jobs in under 5 seconds.",
      "In app video calling and chat features that allow users to connect with recruiters directly.",
      "Easily upload resumes and have them parsed into a profile using AI.",
      "Filter through applicants using several metrics making hiring easier than ever.",
      "AI driven job matching that provides users jobs that fit their skill set and experience.",
    ],
  },
  {
...
function Work() {
  ...
  return (
    <Container className="container">
      <Box className="work">
        {companies.map((workInfo) => (
          <WorkCard information={workInfo} />
        ))}
      </Box>
    </Container>
  );
